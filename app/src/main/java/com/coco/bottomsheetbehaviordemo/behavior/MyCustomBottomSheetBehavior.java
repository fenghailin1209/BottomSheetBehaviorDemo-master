package com.coco.bottomsheetbehaviordemo.behavior;
...
import com.coco.bottomsheetbehaviordemo.utils.MyCustomMathUtils;
 ...
 * a bottom sheet.
 */
public class MyCustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    private static final String TAG = MyCustomBottomSheetBehavior.class.getSimpleName();
     ...
     */
    public MyCustomBottomSheetBehavior() {
    }
     ...
     */
    public MyCustomBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        boolean b3 = Math.abs(mInitialY - event.getY()) > mViewDragHelper.getTouchSlop();
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            return MyCustomMathUtils.constrain(top, mMinOffset, mHideable ? mParentHeight : mMaxOffset);
        }
